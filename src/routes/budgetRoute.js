...
router.post('/', authMiddleware_1.protect, (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { rows: [createdBudget] } = yield index_1.default.query('INSERT INTO "Budget" (budget, user_id, id, created_on, description, divide_by) values ($1, $2, $3, $4, $5, $6) returning *', [budget, username, id, new Date(created_on ? created_on : Date.now()).toISOString(), description, divide_by]);
...
router.post('/:id', authMiddleware_1.protect, (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!budget)
        throw new Error('Provide a budget');
    const { rows: [updatedBudget] } = yield index_1.default.query('UPDATE "Budget" SET budget = $1, description = $2, created_on = $3, divide_by = $4 WHERE id = $5 returning *', [budget, description, new Date(created_on).toISOString(), divide_by, id]);
